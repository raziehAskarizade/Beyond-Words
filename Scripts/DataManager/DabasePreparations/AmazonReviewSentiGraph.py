...
class AmazonReviewSentiGraph:
    ...
    def __init__(self, config: Config, graph_type: TextGraphType = TextGraphType.CO_OCCURRENCE):
        self.config = config
        train_df = pd.read_csv(path.join(config.root, 'data/Amazon-Review/train_sm.csv'))
        test_df = pd.read_csv(path.join(config.root, 'data/Amazon-Review/test_sm.csv'))
        ...
        # train_df = pd.read_csv(path.join(config.root, 'data/GraphData/Amazon-Review/train_sm.csv'))
        # test_df = pd.read_csv(path.join(config.root, 'data/GraphData/Amazon-Review/test_sm.csv'))
