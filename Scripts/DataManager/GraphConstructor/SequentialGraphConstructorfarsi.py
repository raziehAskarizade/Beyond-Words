...
class SequentialGraphConstructorFarsi(GraphConstructor):
    
    class _Variables(GraphConstructor._Variables):
        def __init__(self):
            super(SequentialGraphConstructorFarsi._Variables, self).__init__()
    ...
    def __init__(self, texts: List[str], save_path: str, config: Config,
        ...
        super(SequentialGraphConstructorFarsi, self)\
